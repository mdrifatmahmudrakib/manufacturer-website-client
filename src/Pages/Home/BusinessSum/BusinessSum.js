    ...
    return (
        <div className="mx-12 my-20">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 md:grid-cols-2 shadow-lg pt-4">
                <div class="card lg:w-full rounded-none">
                    <figure class="px-10 pt-10">
                        <FaFlag className="h-16 w-16 text-primary"></FaFlag>
                    </figure>
                    <div class="card-body p-4 items-center text-center">
                        <h2 class="text-3xl font-bold text-black">25</h2>
                        <p className="text-primary font-bold">YEARS EXPERIENCE</p>
                    </div>
                </div>
                <div class="card lg:w-full y rounded-none">
                    <figure class="px-10 pt-10">
                        <FaLaugh className="h-12 w-12 text-primary"></FaLaugh>
                    </figure>
                    <div class="card-body p-4 items-center text-center">
                        <h2 class="text-3xl font-bold text-black">1500+</h2>
                ...
                <div class="card lg:w-full  rounded-none ">
                    ...
                    <div class="card-body p-4 items-center text-center">
                        <h2 class="text-3xl font-bold text-black">350</h2>
                ...
                <div class="card lg:w-full rounded-none ">
                    ...
                    <div class="card-body p-4 items-center text-center">
                        <h2 class="text-3xl font-bold text-black">55</h2>
